# Fiber Scalp v1.9 — EUR/USD M5 Scalping Bot

**Fiber Scalp v1.9** is the updated controlled-risk release. The strategy logic is unchanged, but live risk sizing is now more controlled.
...
|---:|---:|---:|---|
| 4/6 | $30 | ~16,667 units | Valid but normal setup |
| 5/6 | $40 | capped by `max_units` units | Stronger setup |
